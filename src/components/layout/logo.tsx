...
export function LetsShineLogo({ size = 44, withText = true, withSlogan = false, className = "", animated = true }: Props) {
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      >
        <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          ...
          {/* outer ring */}
          <circle cx="32" cy="32" r="29" stroke="url(#ls-ring-grad)" strokeWidth="2.5" fill="rgba(15,23,42,0.85)" />
          ...
          {/* shine rays */}
          <g stroke="#ffd700" strokeWidth="1.2" strokeLinecap="round" opacity="0.7">
      ...
      {withText && (
        <div className="flex flex-col leading-none">
          <span className="font-display font-extrabold text-xl tracking-tight bg-gradient-to-r from-yellow-300 via-amber-400 to-yellow-500 bg-clip-text text-transparent">
            LET'S SHINE
          </span>
          {withSlogan && (
            <span className="text-[10px] uppercase tracking-[0.25em] text-slate-400 mt-1 font-medium">
